...
export ESMF_NETCDF=nc-config
export ESMF_DIR=/scratch1/NCEPDEV/stmp2/Mark.Potts/gfortran_9.2.0_openmpi_O_patch_8.1.1
...
ssh hfe10 /scratch1/NCEPDEV/stmp2/Mark.Potts/gfortran_9.2.0_openmpi_O_patch_8.1.1/runpython.sh 2>&1 | tee python_build.log
