build time -- 2021-04-27 06:08:27
...
ESMF_APPSDIR=/scratch1/NCEPDEV/stmp2/Mark.Potts/gfortran_9.2.0_openmpi_O_patch_8.1.1/apps/appsO/Linux.gfortran.64.openmpi.default
ESMF_LIBSDIR=/scratch1/NCEPDEV/stmp2/Mark.Potts/gfortran_9.2.0_openmpi_O_patch_8.1.1/lib/libO/Linux.gfortran.64.openmpi.default
...
ESMF_F90LINKPATHS=-L/scratch1/NCEPDEV/stmp2/Mark.Potts/gfortran_9.2.0_openmpi_O_patch_8.1.1/lib/libO/Linux.gfortran.64.openmpi.default -L/apps/netcdf/4.7.2/gnu/gcc-9.2.0/lib -L/apps/gnu/gcc-9.2.0/lib64/../lib64/
ESMF_F90ESMFLINKPATHS=-L/scratch1/NCEPDEV/stmp2/Mark.Potts/gfortran_9.2.0_openmpi_O_patch_8.1.1/lib/libO/Linux.gfortran.64.openmpi.default
ESMF_F90LINKRPATHS=-Wl,-rpath,/scratch1/NCEPDEV/stmp2/Mark.Potts/gfortran_9.2.0_openmpi_O_patch_8.1.1/lib/libO/Linux.gfortran.64.openmpi.default -Wl,-rpath,/apps/netcdf/4.7.2/gnu/gcc-9.2.0/lib -Wl,-rpath,/apps/gnu/gcc-9.2.0/lib64/../lib64/
ESMF_F90ESMFLINKRPATHS=-Wl,-rpath,/scratch1/NCEPDEV/stmp2/Mark.Potts/gfortran_9.2.0_openmpi_O_patch_8.1.1/lib/libO/Linux.gfortran.64.openmpi.default
...
ESMF_CXXCOMPILEPATHS= -I/scratch1/NCEPDEV/stmp2/Mark.Potts/gfortran_9.2.0_openmpi_O_patch_8.1.1/src/include  -I/apps/netcdf/4.7.2/gnu/gcc-9.2.0/include -I/scratch1/NCEPDEV/stmp2/Mark.Potts/gfortran_9.2.0_openmpi_O_patch_8.1.1/src/prologue/yaml-cpp/include
ESMF_CXXCOMPILECPPFLAGS=-DESMF_NO_INTEGER_1_BYTE -DESMF_NO_INTEGER_2_BYTE -DESMFVERSIONGIT='ESMF_8_1_1' -DESMF_MOAB=1 -DESMF_LAPACK=1 -DESMF_LAPACK_INTERNAL=1 -DESMF_NO_ACC_SOFTWARE_STACK=1 -DESMF_NETCDF=1 -DESMF_YAMLCPP=1 -DESMF_YAML=1 -DESMF_PIO=1 -DESMF_MPIIO -DESMF_NO_OPENACC -DESMF_TESTEXHAUSTIVE -DESMF_BOPT_O -DESMF_TESTCOMPTUNNEL -DESMF_TESTWITHTHREADS -DSx86_64_small=1 -DESMF_OS_Linux=1 -DESMF_COMM=openmpi -DESMF_DIR=/scratch1/NCEPDEV/stmp2/Mark.Potts/gfortran_9.2.0_openmpi_O_patch_8.1.1 -D__SDIR__='' -DESMF_CXXSTD=11 -DESMF_NO_SIGUSR2

ESMF_CXXLINKOPTS=  -m64 -mcmodel=small -pthread -Wl,--no-as-needed  -fopenmp
ESMF_CXXLINKPATHS=-L/scratch1/NCEPDEV/stmp2/Mark.Potts/gfortran_9.2.0_openmpi_O_patch_8.1.1/lib/libO/Linux.gfortran.64.openmpi.default -L/apps/netcdf/4.7.2/gnu/gcc-9.2.0/lib -L/apps/gnu/gcc-9.2.0/lib64/../lib64/
ESMF_CXXESMFLINKPATHS=-L/scratch1/NCEPDEV/stmp2/Mark.Potts/gfortran_9.2.0_openmpi_O_patch_8.1.1/lib/libO/Linux.gfortran.64.openmpi.default
ESMF_CXXLINKRPATHS=-Wl,-rpath,/scratch1/NCEPDEV/stmp2/Mark.Potts/gfortran_9.2.0_openmpi_O_patch_8.1.1/lib/libO/Linux.gfortran.64.openmpi.default -Wl,-rpath,/apps/netcdf/4.7.2/gnu/gcc-9.2.0/lib -Wl,-rpath,/apps/gnu/gcc-9.2.0/lib64/../lib64/
ESMF_CXXESMFLINKRPATHS=-Wl,-rpath,/scratch1/NCEPDEV/stmp2/Mark.Potts/gfortran_9.2.0_openmpi_O_patch_8.1.1/lib/libO/Linux.gfortran.64.openmpi.default
...
ESMF_TRACE_LDPRELOAD=/scratch1/NCEPDEV/stmp2/Mark.Potts/gfortran_9.2.0_openmpi_O_patch_8.1.1/lib/libO/Linux.gfortran.64.openmpi.default/libesmftrace_preload.so
...
ESMF_INTERNAL_DIR=/scratch1/NCEPDEV/stmp2/Mark.Potts/gfortran_9.2.0_openmpi_O_patch_8.1.1

#
# !!! The following options were used on this ESMF build !!!
#
# ESMF_DIR: /scratch1/NCEPDEV/stmp2/Mark.Potts/gfortran_9.2.0_openmpi_O_patch_8.1.1
# ESMF_OS: Linux
# ESMF_MACHINE: x86_64
# ESMF_ABI: 64
