...
export ESMF_DIR=/scratch1/NCEPDEV/da/Mark.Potts/sandbox/gfortran_9.2.0b_intelmpi_O_patch_8.1.1
...
ssh hfe02 /scratch1/NCEPDEV/da/Mark.Potts/sandbox/gfortran_9.2.0b_intelmpi_O_patch_8.1.1/runpython.sh 2>&1 | tee python_build.log
