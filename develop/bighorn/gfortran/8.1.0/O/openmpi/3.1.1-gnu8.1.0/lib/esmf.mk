build time -- 2021-04-28 12:16:50.214429
...
ESMF_APPSDIR=/scratch/mpotts/gfortran_8.1.0_openmpi_O_develop/apps/appsO/Linux.gfortran.64.openmpi.default
ESMF_LIBSDIR=/scratch/mpotts/gfortran_8.1.0_openmpi_O_develop/lib/libO/Linux.gfortran.64.openmpi.default
...
ESMF_F90LINKPATHS=-L/scratch/mpotts/gfortran_8.1.0_openmpi_O_develop/lib/libO/Linux.gfortran.64.openmpi.default -L/usr/local/netcdf-c-4.6.1-f-4.4.4-gcc-g++-gfortran-8.1.0/lib -L/usr/local/netcdf-c-4.6.1-f-4.4.4-gcc-g++-gfortran-8.1.0/lib -L/usr/local/gcc-g++-gfortran-8.1.0/lib -L/usr/local/hdf5-1.8.7-gcc-g++-gfortran-8.1.0/lib -L/usr/local/netcdf-c-4.6.1-f-4.4.4-gcc-g++-gfortran-8.1.0/lib -L/usr/local/gcc-g++-gfortran-8.1.0/lib/gcc/x86_64-pc-linux-gnu/8.1.0/../../../../lib64/
ESMF_F90ESMFLINKPATHS=-L/scratch/mpotts/gfortran_8.1.0_openmpi_O_develop/lib/libO/Linux.gfortran.64.openmpi.default
ESMF_F90LINKRPATHS=-Wl,-rpath,/scratch/mpotts/gfortran_8.1.0_openmpi_O_develop/lib/libO/Linux.gfortran.64.openmpi.default -Wl,-rpath,/usr/local/netcdf-c-4.6.1-f-4.4.4-gcc-g++-gfortran-8.1.0/lib -Wl,-rpath,/usr/local/netcdf-c-4.6.1-f-4.4.4-gcc-g++-gfortran-8.1.0/lib -Wl,-rpath,/usr/local/gcc-g++-gfortran-8.1.0/lib -Wl,-rpath,/usr/local/hdf5-1.8.7-gcc-g++-gfortran-8.1.0/lib -Wl,-rpath,/usr/local/netcdf-c-4.6.1-f-4.4.4-gcc-g++-gfortran-8.1.0/lib -Wl,-rpath,/usr/local/gcc-g++-gfortran-8.1.0/lib/gcc/x86_64-pc-linux-gnu/8.1.0/../../../../lib64/
ESMF_F90ESMFLINKRPATHS=-Wl,-rpath,/scratch/mpotts/gfortran_8.1.0_openmpi_O_develop/lib/libO/Linux.gfortran.64.openmpi.default
...
ESMF_CXXCOMPILEPATHS= -I/scratch/mpotts/gfortran_8.1.0_openmpi_O_develop/src/include  -I/usr/local/netcdf-c-4.6.1-f-4.4.4-gcc-g++-gfortran-8.1.0/include -I/scratch/mpotts/gfortran_8.1.0_openmpi_O_develop/src/prologue/yaml-cpp/include
...
ESMF_CXXLINKPATHS=-L/scratch/mpotts/gfortran_8.1.0_openmpi_O_develop/lib/libO/Linux.gfortran.64.openmpi.default -L/usr/local/netcdf-c-4.6.1-f-4.4.4-gcc-g++-gfortran-8.1.0/lib -L/usr/local/netcdf-c-4.6.1-f-4.4.4-gcc-g++-gfortran-8.1.0/lib -L/usr/local/gcc-g++-gfortran-8.1.0/lib -L/usr/local/hdf5-1.8.7-gcc-g++-gfortran-8.1.0/lib -L/usr/local/netcdf-c-4.6.1-f-4.4.4-gcc-g++-gfortran-8.1.0/lib -L/usr/local/gcc-g++-gfortran-8.1.0/lib/gcc/x86_64-pc-linux-gnu/8.1.0/../../../../lib64/
ESMF_CXXESMFLINKPATHS=-L/scratch/mpotts/gfortran_8.1.0_openmpi_O_develop/lib/libO/Linux.gfortran.64.openmpi.default
ESMF_CXXLINKRPATHS=-Wl,-rpath,/scratch/mpotts/gfortran_8.1.0_openmpi_O_develop/lib/libO/Linux.gfortran.64.openmpi.default -Wl,-rpath,/usr/local/netcdf-c-4.6.1-f-4.4.4-gcc-g++-gfortran-8.1.0/lib -Wl,-rpath,/usr/local/netcdf-c-4.6.1-f-4.4.4-gcc-g++-gfortran-8.1.0/lib -Wl,-rpath,/usr/local/gcc-g++-gfortran-8.1.0/lib -Wl,-rpath,/usr/local/hdf5-1.8.7-gcc-g++-gfortran-8.1.0/lib -Wl,-rpath,/usr/local/netcdf-c-4.6.1-f-4.4.4-gcc-g++-gfortran-8.1.0/lib -Wl,-rpath,/usr/local/gcc-g++-gfortran-8.1.0/lib/gcc/x86_64-pc-linux-gnu/8.1.0/../../../../lib64/
ESMF_CXXESMFLINKRPATHS=-Wl,-rpath,/scratch/mpotts/gfortran_8.1.0_openmpi_O_develop/lib/libO/Linux.gfortran.64.openmpi.default
...
ESMF_TRACE_LDPRELOAD=/scratch/mpotts/gfortran_8.1.0_openmpi_O_develop/lib/libO/Linux.gfortran.64.openmpi.default/libesmftrace_preload.so
...
ESMF_INTERNAL_DIR=/scratch/mpotts/gfortran_8.1.0_openmpi_O_develop

#
# !!! The following options were used on this ESMF build !!!
#
# ESMF_DIR: /scratch/mpotts/gfortran_8.1.0_openmpi_O_develop
# ESMF_OS: Linux
# ESMF_MACHINE: x86_64
# ESMF_ABI: 64
