...
ESMF_APPSDIR=/scratch/mpotts/gfortran_8.1.0_mpich3_O_develop/apps/appsO/Linux.gfortran.64.mpich3.default
ESMF_LIBSDIR=/scratch/mpotts/gfortran_8.1.0_mpich3_O_develop/lib/libO/Linux.gfortran.64.mpich3.default
...
ESMF_F90LINKPATHS=-L/scratch/mpotts/gfortran_8.1.0_mpich3_O_develop/lib/libO/Linux.gfortran.64.mpich3.default -L/usr/local/netcdf-c-4.6.1-f-4.4.4-gcc-g++-gfortran-8.1.0/lib -L/usr/local/netcdf-c-4.6.1-f-4.4.4-gcc-g++-gfortran-8.1.0/lib -L/usr/local/gcc-g++-gfortran-8.1.0/lib -L/usr/local/hdf5-1.8.7-gcc-g++-gfortran-8.1.0/lib -L/usr/local/netcdf-c-4.6.1-f-4.4.4-gcc-g++-gfortran-8.1.0/lib -L/usr/local/gcc-g++-gfortran-8.1.0/lib/gcc/x86_64-pc-linux-gnu/8.1.0/../../../../lib64/
ESMF_F90ESMFLINKPATHS=-L/scratch/mpotts/gfortran_8.1.0_mpich3_O_develop/lib/libO/Linux.gfortran.64.mpich3.default
ESMF_F90LINKRPATHS=-Wl,-rpath,/scratch/mpotts/gfortran_8.1.0_mpich3_O_develop/lib/libO/Linux.gfortran.64.mpich3.default -Wl,-rpath,/usr/local/netcdf-c-4.6.1-f-4.4.4-gcc-g++-gfortran-8.1.0/lib -Wl,-rpath,/usr/local/netcdf-c-4.6.1-f-4.4.4-gcc-g++-gfortran-8.1.0/lib -Wl,-rpath,/usr/local/gcc-g++-gfortran-8.1.0/lib -Wl,-rpath,/usr/local/hdf5-1.8.7-gcc-g++-gfortran-8.1.0/lib -Wl,-rpath,/usr/local/netcdf-c-4.6.1-f-4.4.4-gcc-g++-gfortran-8.1.0/lib -Wl,-rpath,/usr/local/gcc-g++-gfortran-8.1.0/lib/gcc/x86_64-pc-linux-gnu/8.1.0/../../../../lib64/
ESMF_F90ESMFLINKRPATHS=-Wl,-rpath,/scratch/mpotts/gfortran_8.1.0_mpich3_O_develop/lib/libO/Linux.gfortran.64.mpich3.default
...
ESMF_CXXCOMPILEPATHS= -I/scratch/mpotts/gfortran_8.1.0_mpich3_O_develop/src/include  -I/usr/local/netcdf-c-4.6.1-f-4.4.4-gcc-g++-gfortran-8.1.0/include -I/scratch/mpotts/gfortran_8.1.0_mpich3_O_develop/src/prologue/yaml-cpp/include
ESMF_CXXCOMPILECPPFLAGS=-DESMF_NO_INTEGER_1_BYTE -DESMF_NO_INTEGER_2_BYTE -DESMF_VERSION_STRING_GIT='ESMF_8_2_0_beta_snapshot_05-6-gb8c1a7077f' -DESMF_MOAB=1 -DESMF_LAPACK=1 -DESMF_LAPACK_INTERNAL=1 -DESMF_NO_ACC_SOFTWARE_STACK=1 -DESMF_NETCDF=1 -DESMF_YAMLCPP=1 -DESMF_YAML=1 -DESMF_PIO=1 -DESMF_MPIIO -DESMF_NO_OPENACC -DESMF_TESTEXHAUSTIVE -DESMF_BOPT_O -DESMF_TESTCOMPTUNNEL -DESMF_TESTWITHTHREADS -DSx86_64_small=1 -DESMF_OS_Linux=1 -DESMF_COMM=mpich3 -DESMF_DIR=/scratch/mpotts/gfortran_8.1.0_mpich3_O_develop -D__SDIR__='' -DESMF_CXXSTD=11

ESMF_CXXLINKOPTS=  -m64 -mcmodel=small -pthread -Wl,--no-as-needed  -fopenmp
ESMF_CXXLINKPATHS=-L/scratch/mpotts/gfortran_8.1.0_mpich3_O_develop/lib/libO/Linux.gfortran.64.mpich3.default -L/usr/local/netcdf-c-4.6.1-f-4.4.4-gcc-g++-gfortran-8.1.0/lib -L/usr/local/netcdf-c-4.6.1-f-4.4.4-gcc-g++-gfortran-8.1.0/lib -L/usr/local/gcc-g++-gfortran-8.1.0/lib -L/usr/local/hdf5-1.8.7-gcc-g++-gfortran-8.1.0/lib -L/usr/local/netcdf-c-4.6.1-f-4.4.4-gcc-g++-gfortran-8.1.0/lib -L/usr/local/gcc-g++-gfortran-8.1.0/lib/gcc/x86_64-pc-linux-gnu/8.1.0/../../../../lib64/
ESMF_CXXESMFLINKPATHS=-L/scratch/mpotts/gfortran_8.1.0_mpich3_O_develop/lib/libO/Linux.gfortran.64.mpich3.default
ESMF_CXXLINKRPATHS=-Wl,-rpath,/scratch/mpotts/gfortran_8.1.0_mpich3_O_develop/lib/libO/Linux.gfortran.64.mpich3.default -Wl,-rpath,/usr/local/netcdf-c-4.6.1-f-4.4.4-gcc-g++-gfortran-8.1.0/lib -Wl,-rpath,/usr/local/netcdf-c-4.6.1-f-4.4.4-gcc-g++-gfortran-8.1.0/lib -Wl,-rpath,/usr/local/gcc-g++-gfortran-8.1.0/lib -Wl,-rpath,/usr/local/hdf5-1.8.7-gcc-g++-gfortran-8.1.0/lib -Wl,-rpath,/usr/local/netcdf-c-4.6.1-f-4.4.4-gcc-g++-gfortran-8.1.0/lib -Wl,-rpath,/usr/local/gcc-g++-gfortran-8.1.0/lib/gcc/x86_64-pc-linux-gnu/8.1.0/../../../../lib64/
ESMF_CXXESMFLINKRPATHS=-Wl,-rpath,/scratch/mpotts/gfortran_8.1.0_mpich3_O_develop/lib/libO/Linux.gfortran.64.mpich3.default
...
ESMF_TRACE_LDPRELOAD=/scratch/mpotts/gfortran_8.1.0_mpich3_O_develop/lib/libO/Linux.gfortran.64.mpich3.default/libesmftrace_preload.so
...
ESMF_INTERNAL_DIR=/scratch/mpotts/gfortran_8.1.0_mpich3_O_develop

#
# !!! The following options were used on this ESMF build !!!
#
# ESMF_DIR: /scratch/mpotts/gfortran_8.1.0_mpich3_O_develop
# ESMF_OS: Linux
# ESMF_MACHINE: x86_64
# ESMF_ABI: 64
