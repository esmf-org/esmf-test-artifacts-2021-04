build time -- 2021-04-28 10:56:36.496283
...
ESMF_APPSDIR=/scratch/mpotts/gfortran_4.8.5_openmpi_O_develop/apps/appsO/Linux.gfortran.64.openmpi.default
ESMF_LIBSDIR=/scratch/mpotts/gfortran_4.8.5_openmpi_O_develop/lib/libO/Linux.gfortran.64.openmpi.default
...
ESMF_F90LINKPATHS=-L/scratch/mpotts/gfortran_4.8.5_openmpi_O_develop/lib/libO/Linux.gfortran.64.openmpi.default -L/usr/local/netcdf-c-4.6.1-f-4.4.4-gcc-g++-gfortran-4.8.5/lib -L/usr/local/netcdf-c-4.6.1-f-4.4.4-gcc-g++-gfortran-4.8.5/lib -L/usr/local/netcdf/lib -L/usr/lib/gcc/x86_64-redhat-linux/4.8.5/
ESMF_F90ESMFLINKPATHS=-L/scratch/mpotts/gfortran_4.8.5_openmpi_O_develop/lib/libO/Linux.gfortran.64.openmpi.default
ESMF_F90LINKRPATHS=-Wl,-rpath,/scratch/mpotts/gfortran_4.8.5_openmpi_O_develop/lib/libO/Linux.gfortran.64.openmpi.default -Wl,-rpath,/usr/local/netcdf-c-4.6.1-f-4.4.4-gcc-g++-gfortran-4.8.5/lib -Wl,-rpath,/usr/local/netcdf-c-4.6.1-f-4.4.4-gcc-g++-gfortran-4.8.5/lib -Wl,-rpath,/usr/local/netcdf/lib -Wl,-rpath,/usr/lib/gcc/x86_64-redhat-linux/4.8.5/
ESMF_F90ESMFLINKRPATHS=-Wl,-rpath,/scratch/mpotts/gfortran_4.8.5_openmpi_O_develop/lib/libO/Linux.gfortran.64.openmpi.default
...
ESMF_CXXCOMPILEPATHS= -I/scratch/mpotts/gfortran_4.8.5_openmpi_O_develop/src/include  -I/usr/local/netcdf-c-4.6.1-f-4.4.4-gcc-g++-gfortran-4.8.5/include -I/scratch/mpotts/gfortran_4.8.5_openmpi_O_develop/src/prologue/yaml-cpp/include
ESMF_CXXCOMPILECPPFLAGS=-DESMF_NO_INTEGER_1_BYTE -DESMF_NO_INTEGER_2_BYTE -DESMF_VERSION_STRING_GIT='ESMF_8_2_0_beta_snapshot_05-6-gb8c1a7077f' -DESMF_MOAB=1 -DESMF_LAPACK=1 -DESMF_LAPACK_INTERNAL=1 -DESMF_NO_ACC_SOFTWARE_STACK=1 -DESMF_NETCDF=1 -DESMF_YAMLCPP=1 -DESMF_YAML=1 -DESMF_PIO=1 -DESMF_MPIIO -DESMF_NO_OPENACC -DESMF_TESTEXHAUSTIVE -DESMF_BOPT_O -DESMF_TESTCOMPTUNNEL -DESMF_TESTWITHTHREADS -DSx86_64_small=1 -DESMF_OS_Linux=1 -DESMF_COMM=openmpi -DESMF_DIR=/scratch/mpotts/gfortran_4.8.5_openmpi_O_develop -D__SDIR__='' -DESMF_CXXSTD=11 -DESMF_NO_SIGUSR2

ESMF_CXXLINKOPTS=  -m64 -mcmodel=small -pthread -Wl,--no-as-needed  -fopenmp
ESMF_CXXLINKPATHS=-L/scratch/mpotts/gfortran_4.8.5_openmpi_O_develop/lib/libO/Linux.gfortran.64.openmpi.default -L/usr/local/netcdf-c-4.6.1-f-4.4.4-gcc-g++-gfortran-4.8.5/lib -L/usr/local/netcdf-c-4.6.1-f-4.4.4-gcc-g++-gfortran-4.8.5/lib -L/usr/local/netcdf/lib -L/usr/lib/gcc/x86_64-redhat-linux/4.8.5/
ESMF_CXXESMFLINKPATHS=-L/scratch/mpotts/gfortran_4.8.5_openmpi_O_develop/lib/libO/Linux.gfortran.64.openmpi.default
ESMF_CXXLINKRPATHS=-Wl,-rpath,/scratch/mpotts/gfortran_4.8.5_openmpi_O_develop/lib/libO/Linux.gfortran.64.openmpi.default -Wl,-rpath,/usr/local/netcdf-c-4.6.1-f-4.4.4-gcc-g++-gfortran-4.8.5/lib -Wl,-rpath,/usr/local/netcdf-c-4.6.1-f-4.4.4-gcc-g++-gfortran-4.8.5/lib -Wl,-rpath,/usr/local/netcdf/lib -Wl,-rpath,/usr/lib/gcc/x86_64-redhat-linux/4.8.5/
ESMF_CXXESMFLINKRPATHS=-Wl,-rpath,/scratch/mpotts/gfortran_4.8.5_openmpi_O_develop/lib/libO/Linux.gfortran.64.openmpi.default
...
ESMF_TRACE_LDPRELOAD=/scratch/mpotts/gfortran_4.8.5_openmpi_O_develop/lib/libO/Linux.gfortran.64.openmpi.default/libesmftrace_preload.so
...
ESMF_INTERNAL_DIR=/scratch/mpotts/gfortran_4.8.5_openmpi_O_develop

#
# !!! The following options were used on this ESMF build !!!
#
# ESMF_DIR: /scratch/mpotts/gfortran_4.8.5_openmpi_O_develop
# ESMF_OS: Linux
# ESMF_MACHINE: x86_64
# ESMF_ABI: 64
...
# ESMF_NETCDF_INCLUDE:    /usr/local/netcdf-c-4.6.1-f-4.4.4-gcc-g++-gfortran-4.8.5/include
# ESMF_NETCDF_LIBS:       -lnetcdf
# ESMF_NETCDF_LIBPATH:    /usr/local/netcdf-c-4.6.1-f-4.4.4-gcc-g++-gfortran-4.8.5/lib
# ESMF_NFCONFIG:          nf-config
# ESMF_NETCDFF_INCLUDE:   /usr/local/netcdf-c-4.6.1-f-4.4.4-gcc-g++-gfortran-4.8.5/include
# ESMF_NETCDFF_LIBS:      -lnetcdff -lnetcdf -lnetcdf
# ESMF_NETCDFF_LIBPATH:   /usr/local/netcdf-c-4.6.1-f-4.4.4-gcc-g++-gfortran-4.8.5/lib /usr/local/netcdf/lib
# ESMF_PIO:               internal
