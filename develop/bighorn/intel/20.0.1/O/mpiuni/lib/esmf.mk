build time -- 2021-04-28 13:22:27.509221
...
ESMF_APPSDIR=/scratch/mpotts/intel_20.0.1_mpiuni_O_develop/apps/appsO/Linux.intel.64.mpiuni.default
ESMF_LIBSDIR=/scratch/mpotts/intel_20.0.1_mpiuni_O_develop/lib/libO/Linux.intel.64.mpiuni.default
...
ESMF_F90COMPILEPATHS=-I/scratch/mpotts/intel_20.0.1_mpiuni_O_develop/mod/modO/Linux.intel.64.mpiuni.default -I/scratch/mpotts/intel_20.0.1_mpiuni_O_develop/src/include -I/usr/local/netcdf-c-4.6.1-f-4.4.4-intel-cluster-18.0.3/include -I/usr/local/netcdf-c-4.6.1-f-4.4.4-intel-cluster-18.0.3/include
ESMF_F90COMPILECPPFLAGS=-DESMF_NO_INTEGER_1_BYTE -DESMF_NO_INTEGER_2_BYTE -DESMF_VERSION_STRING_GIT='ESMF_8_2_0_beta_snapshot_05-6-gb8c1a7077f' -DESMF_MOAB=1 -DESMF_LAPACK=1 -DESMF_LAPACK_INTERNAL=1 -DESMF_NO_ACC_SOFTWARE_STACK=1 -DESMF_NETCDF=1 -DESMF_YAMLCPP=1 -DESMF_YAML=1 -DESMF_NO_OPENACC -DESMF_TESTEXHAUSTIVE -DESMF_BOPT_O -DESMF_TESTCOMPTUNNEL -DESMF_TESTWITHTHREADS -DSx86_64_small=1 -DESMF_OS_Linux=1 -DESMF_COMM=mpiuni -DESMF_DIR=/scratch/mpotts/intel_20.0.1_mpiuni_O_develop -DESMF_MPIUNI
...
ESMF_F90LINKPATHS=-L/scratch/mpotts/intel_20.0.1_mpiuni_O_develop/lib/libO/Linux.intel.64.mpiuni.default -L/usr/local/netcdf-c-4.6.1-f-4.4.4-intel-cluster-18.0.3/lib -L/usr/local/netcdf-c-4.6.1-f-4.4.4-intel-cluster-18.0.3/lib -L/usr/local/hdf5-1.8.20-intel-cluster-18.03/lib -L/usr/local/netcdf-c-4.6.1-f-4.4.4-intel-cluster-18.0.3/lib 
ESMF_F90ESMFLINKPATHS=-L/scratch/mpotts/intel_20.0.1_mpiuni_O_develop/lib/libO/Linux.intel.64.mpiuni.default
ESMF_F90LINKRPATHS=-Wl,-rpath,/scratch/mpotts/intel_20.0.1_mpiuni_O_develop/lib/libO/Linux.intel.64.mpiuni.default -Wl,-rpath,/usr/local/netcdf-c-4.6.1-f-4.4.4-intel-cluster-18.0.3/lib -Wl,-rpath,/usr/local/netcdf-c-4.6.1-f-4.4.4-intel-cluster-18.0.3/lib -Wl,-rpath,/usr/local/hdf5-1.8.20-intel-cluster-18.03/lib -Wl,-rpath,/usr/local/netcdf-c-4.6.1-f-4.4.4-intel-cluster-18.0.3/lib
ESMF_F90ESMFLINKRPATHS=-Wl,-rpath,/scratch/mpotts/intel_20.0.1_mpiuni_O_develop/lib/libO/Linux.intel.64.mpiuni.default
...
ESMF_CXXCOMPILEPATHS= -I/scratch/mpotts/intel_20.0.1_mpiuni_O_develop/src/include  -I/usr/local/netcdf-c-4.6.1-f-4.4.4-intel-cluster-18.0.3/include -I/scratch/mpotts/intel_20.0.1_mpiuni_O_develop/src/Infrastructure/stubs/mpiuni -I/scratch/mpotts/intel_20.0.1_mpiuni_O_develop/src/prologue/yaml-cpp/include
ESMF_CXXCOMPILECPPFLAGS=-DESMF_NO_INTEGER_1_BYTE -DESMF_NO_INTEGER_2_BYTE -DESMF_VERSION_STRING_GIT='ESMF_8_2_0_beta_snapshot_05-6-gb8c1a7077f' -DESMF_MOAB=1 -DESMF_LAPACK=1 -DESMF_LAPACK_INTERNAL=1 -DESMF_NO_ACC_SOFTWARE_STACK=1 -DESMF_NETCDF=1 -DESMF_YAMLCPP=1 -DESMF_YAML=1 -DESMF_NO_OPENACC -DESMF_TESTEXHAUSTIVE -DESMF_BOPT_O -DESMF_TESTCOMPTUNNEL -DESMF_TESTWITHTHREADS -DSx86_64_small=1 -DESMF_OS_Linux=1 -DESMF_COMM=mpiuni -DESMF_DIR=/scratch/mpotts/intel_20.0.1_mpiuni_O_develop -D__SDIR__='' -DESMF_CXXSTD=11 -DESMF_MPIUNI

ESMF_CXXLINKOPTS=  -m64 -mcmodel=small -pthread -Wl,--no-as-needed  -qopenmp
ESMF_CXXLINKPATHS=-L/scratch/mpotts/intel_20.0.1_mpiuni_O_develop/lib/libO/Linux.intel.64.mpiuni.default -L/usr/local/netcdf-c-4.6.1-f-4.4.4-intel-cluster-18.0.3/lib -L/usr/local/netcdf-c-4.6.1-f-4.4.4-intel-cluster-18.0.3/lib -L/usr/local/hdf5-1.8.20-intel-cluster-18.03/lib -L/usr/local/netcdf-c-4.6.1-f-4.4.4-intel-cluster-18.0.3/lib -L/usr/local/intel-cluster-20.0.1/compilers_and_libraries_2020.0.166/linux/compiler/lib/intel64_lin/
ESMF_CXXESMFLINKPATHS=-L/scratch/mpotts/intel_20.0.1_mpiuni_O_develop/lib/libO/Linux.intel.64.mpiuni.default
ESMF_CXXLINKRPATHS=-Wl,-rpath,/scratch/mpotts/intel_20.0.1_mpiuni_O_develop/lib/libO/Linux.intel.64.mpiuni.default -Wl,-rpath,/usr/local/netcdf-c-4.6.1-f-4.4.4-intel-cluster-18.0.3/lib -Wl,-rpath,/usr/local/netcdf-c-4.6.1-f-4.4.4-intel-cluster-18.0.3/lib -Wl,-rpath,/usr/local/hdf5-1.8.20-intel-cluster-18.03/lib -Wl,-rpath,/usr/local/netcdf-c-4.6.1-f-4.4.4-intel-cluster-18.0.3/lib -Wl,-rpath,/usr/local/intel-cluster-20.0.1/compilers_and_libraries_2020.0.166/linux/compiler/lib/intel64_lin/
ESMF_CXXESMFLINKRPATHS=-Wl,-rpath,/scratch/mpotts/intel_20.0.1_mpiuni_O_develop/lib/libO/Linux.intel.64.mpiuni.default
...
ESMF_TRACE_LDPRELOAD=/scratch/mpotts/intel_20.0.1_mpiuni_O_develop/lib/libO/Linux.intel.64.mpiuni.default/libesmftrace_preload.so
...
ESMF_INTERNAL_DIR=/scratch/mpotts/intel_20.0.1_mpiuni_O_develop

#
# !!! The following options were used on this ESMF build !!!
#
# ESMF_DIR: /scratch/mpotts/intel_20.0.1_mpiuni_O_develop
# ESMF_OS: Linux
# ESMF_MACHINE: x86_64
# ESMF_ABI: 64
# ESMF_COMPILER: intel
